    ...
    <div class="row">
        <div class="col-md-12"  style="padding-top:2em;">
            <div class="search d1" style="margin-bottom:10px;">
                <div method="post">
                    <input style="color:#000;" type="text" name="keyword" id="keyword" placeholder="请输入商品编码">
...
<script type="text/javascript" src="waresBuysList.js"></script>
<script type="text/javascript">
    ...
    function selectList() {
        ...
        myAjax(url + "api/waresManage/selectBuysList",datalist);
        if(ajaxResult == '-999'){
            ...
            if(res.code == "0"){
                ...
                for (var i=0; i<res.data.length; i++){
                    var reserve1;
                    if(null == res.data[i].reserve1){
                        reserve1 = "";
                    }else{
                        reserve1 = res.data[i].reserve1;
                    }
                    str += "<tr><td class='hide'>"+ res.data[i].buyno +"</td><td name='hideid'>" + res.data[i].buyer + "</td><td name='selectop'>" + res.data[i].warescode + "</td><td name='nochange'>" + res.data[i].waresname + "</td><td name='isnumber'>" + res.data[i].gmv + "</td><td name='istime'>" + res.data[i].buytime + "</td><td>" + reserve1 + "</td></tr>";
                }
                select.text("");
                select.append(str);
            }else{
    ...
    function exportExcel() {
        ...
        exportExcelWithParams(url + "api/waresManage/ExportBuysList",excellist,"交易记录表_" + getCurrentTime(0) + "_" + userCode + ".xls");
    }
