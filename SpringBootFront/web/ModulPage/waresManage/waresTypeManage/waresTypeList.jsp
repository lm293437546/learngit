    ...
    <div class="row">
        <div class="col-md-12"  style="padding-top:2em;">
            <div class="search d1" style="margin-bottom:10px;">
                <div method="post">
                    <input style="color:#000;" type="text" name="keyword" id="keyword" placeholder="请输入商品编码或者商品名称">
...
<script type="text/javascript" src="waresTypeList.js"></script>
<script type="text/javascript">
    ...
    function selectList() {
        ...
        myAjax(url + "api/waresManage/selectWaresTypeList",datalist);
        if(ajaxResult == '-999'){
            ...
            if(res.code == "0"){
                ...
                for (var i=0; i<res.data.length; i++){
                    ...
                    str += "<tr><td class='hide'>"+ res.data[i].warescode +"</td><td name='hideid'>" + res.data[i].warescode + "</td><td>" + res.data[i].waresname + "</td><td>" + reserve1 + "</td></tr>";
                }
                select.text("");
                select.append(str);
            }else{
    ...
    function exportExcel() {
        ...
        exportExcelWithParams(url + "api/waresManage/ExportWaresTypeList",excellist,"商品类型表_" + getCurrentTime(0) + "_" + userCode + ".xls");
    }
