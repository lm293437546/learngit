...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml,price, type, options) {
...
//		var $btnArea = $("<div>").addClass("btnArea");//按钮区域
		...
		var $input = $("<input>").addClass("inputBox").val(price);//输入框
		...
		//关闭按钮事件
		function doClose(){
            if('用户已失效，请重新登录' == popHtml){
                // 页面跳转
                window.top.location.replace("/xws.jsp");
			}
			$("#" + popId).remove();
